        ...
        colModel: [
            ...
            { name: "ActiveStatus", width: 35, editable: false, align: 'center', edittype: "checkbox", formatter: 'checkbox', editoptions: { value: "true:false" }, formatoptions: { disabled: true } },
            {
                ...
                formatter: function (cellValue, options, rowdata, action) {
                    return '<button class="btn-xs ui-button ui-widget ui-corner-all btn-jqgrid" title="Edit" id="jqgEdit", onclick="return fnEditLocalizationTable(event,\'edit\')"><i class="fas fa-pen"></i><span class="sm_text-hide"> ' + localization.Edit + '</span></button>' +
                        '<button class="btn-xs ui-button ui-widget ui-corner-all btn-jqgrid" title ="View" id = "jqgView", onclick = "return fnEditLocalizationTable(event,\'view\')"><i class="far fa-eye"></i><span class="sm_text-hide">' + localization.View + '</span></button>' +
                        '<button class="btn-xs ui-button ui-widget ui-corner-all btn-jqgrid" title = "Delete" id="jqgDelete" onclick = "return fnEditLocalizationTable(event,\'delete\')" > <i class="fas fa-trash"></i><span class="sm_text-hide">' + localization.Delete + '</span></button >'
                }
            }
        ],
        rowNum: 10,
