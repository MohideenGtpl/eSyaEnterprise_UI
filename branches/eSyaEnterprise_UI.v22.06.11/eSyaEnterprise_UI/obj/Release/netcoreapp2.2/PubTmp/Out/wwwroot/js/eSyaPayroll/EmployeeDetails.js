...
function IsValidEmployee() {
    ...
    {
        toastr.warning("Please Select Employee Image");
        return false;
    }
...
function IsValidEmployeePersonalInfo() {
    ...
    if ($("#cboCaste").val() === "0") {
        toastr.warning("Please Select Caste");
        return false;
    }
    if ($("#cboUniqueId").val() === "0") {
        toastr.warning("Please Select Unique ID");
        return false;
    }

    if ($("#cboPermanentOrCurrent").val() === "0") {
        toastr.warning("Please Select Permanent Or Current Address");
        return false;
    }
    ...
    if (IsStringNullorEmpty($("#txtPincode").val())) {
        toastr.warning("Please Enter Pin Code");
        return false;
    }
