...
namespace eSyaEnterprise_UI.Areas.eSyaServices.Controllers
{
    ...
    public class ClinicServicesController : Controller
    {
        ...
        public async Task<IActionResult> V_1518_00()
        {
            ...
            var serviceResponse3 = await _eSyaServicesAPIServices.HttpClientServices.GetAsync<List<DO_ApplicationCode>>("CommonMethod/GetApplicationCodesByCodeType?codetype=62");
        ...
        public async Task<ActionResult> GetClinicVisitRateByBKeyClinicTypeCurrCodeRateType(int businessKey, int clinictype, string currencycode, int ratetype)
        {
            try
            {
                var serviceResponse = await _eSyaServicesAPIServices.HttpClientServices.GetAsync<List<DO_ClinicVisitRate>>("ClinicServices/GetClinicVisitRateByBKeyClinicTypeCurrCodeRateType?businessKey=" + businessKey + "&clinictype=" + clinictype + "&currencycode=" + currencycode + "&ratetype=" + ratetype);
                if (serviceResponse.Status)
                {
                    if (serviceResponse.Data != null)
                    {
