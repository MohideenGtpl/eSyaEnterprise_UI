...
namespace eSyaEnterprise_UI.Areas.eSyaFixedAssets.Controllers
{
    ...
    public class FixedAssetsController : Controller
    {
        ...
        public async Task<JsonResult> GetAssetGroupforGrid()
        {
            ...
            try
            {
                var response = await _eSyaFixedAssetsAPIServices.HttpClientServices.GetAsync<List<DO_AssetGroup>>("AssetGroup/GetAssetGroupforGrid");
                if (response.Status)
                {
        ...
        public async Task<JsonResult> GetAssetDepreciationMethodsbyAssGroupId(int assetGroupId)
        {
            try
            {
                var response = await _eSyaFixedAssetsAPIServices.HttpClientServices.GetAsync<List<DO_AssetDepreciationMethod>>("AssetGroup/GetAssetDepreciationMethodsbyAssGroupId?assetGroupId=" + assetGroupId);
                if (response.Status)
                    return Json(response.Data);
                else
                {
        ...
        public JsonResult InsertDepreciationMethod(List<DO_AssetDepreciationMethod> obj)
        {
            ...
            try
            {
                ...
                var response = _eSyaFixedAssetsAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("AssetGroup/InsertDepreciationMethod", obj).Result;
                if (response.Status)
                    return Json(response.Data);
                else
                {
