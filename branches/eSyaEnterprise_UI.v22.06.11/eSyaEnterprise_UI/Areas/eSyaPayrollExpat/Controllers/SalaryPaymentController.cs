...
namespace eSyaEnterprise_UI.Areas.eSyaPayrollExpat.Controllers
{
    ...
    public class SalaryPaymentController : Controller
    {
        ...
        public async Task<JsonResult> GetBankName(int businessKey)
        {
            try
            {
                string parameter = "?businessKey=" + businessKey;
                var serviceResponse = await _eSyaPayrollExpatAPIServices.HttpClientServices.GetAsync<List<DO_BankMaster>>("SalaryPayment/GetPaymentBankMaster" + parameter);
                ...
                {
                    _logger.LogError(new Exception(serviceResponse.Message), "UD:GetBankName");
        ...
        public async Task<JsonResult> GetBankCurrency(int businessKey, string bankCode)
        {
            try
            {
                string parameter = "?businessKey=" + businessKey;
