...
namespace eSyaEnterprise_UI.Areas.Configure.Controllers
{
    ...
    public class CurrenciesController : Controller
    {
        ...
        public async Task<JsonResult> GetCurrencyMaster()
        {
            ...
            try
            {
                var serviceResponse = await _configAPIServices.HttpClientServices.GetAsync<List<DO_CurrencyMaster>>("CurrencyMaster/GetCurrencyMaster");
        ...
        public async Task<JsonResult> InsertIntoCurrencyMaster(DO_CurrencyMaster currency)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("CurrencyMaster/InsertIntoCurrencyMaster", currency);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
        ...
        public async Task<JsonResult> UpdateCurrencyMaster(DO_CurrencyMaster currency)
        {
            ...
            try
            {
                ...
                currency.TerminalID = AppSessionVariables.GetIPAddress(HttpContext);
                currency.FormId = AppSessionVariables.GetSessionFormInternalID(HttpContext);
                var serviceResponse = await _configAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("CurrencyMaster/UpdateCurrencyMaster", currency);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> ActiveOrDeActiveCurrencyMaster(bool status, string currency_code)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.GetAsync<DO_ReturnParameter>("CurrencyMaster/ActiveOrDeActiveCurrencyMaster" + parameter);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> GetCurrencyDenominationInfoByCurrencyCode(string CurrencyCode)
        {
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.GetAsync<List<DO_CurrencyDenominationInformation>>("CurrencyMaster/GetCurrencyDenominationInfoByCurrencyCode" + parameter);
                if (serviceResponse.Status)
                {
                    return Json(serviceResponse.Data);
                }
        ...
        public async Task<JsonResult> InsertUpdateCurrencyDenominationInformation(bool isInsert, DO_CurrencyDenominationInformation obj)
        {
            try
            {
                ...
                if (isInsert)
                {
                    var serviceResponse = await _configAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("CurrencyMaster/InsertCurrencyDenominationInformation", obj);
                    if (serviceResponse.Status)
                        return Json(serviceResponse.Data);
                    else
                        return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
                ...
                {
                    var serviceResponse = await _configAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("CurrencyMaster/UpdateCurrencyDenominationInformation", obj);
                    if (serviceResponse.Status)
                        return Json(serviceResponse.Data);
                    else
                        return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> DeleteCurrencyDenominationInformation(string currencyCode, decimal DenomId, string BnorCNId)
        {
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.GetAsync<DO_ReturnParameter>("CurrencyMaster/DeleteCurrencyDenominationInformation" + parameter);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> ActiveOrDeActiveCurrencyDenomination(bool status, string currencycode, int denomId)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.GetAsync<DO_ReturnParameter>("CurrencyMaster/ActiveOrDeActiveCurrencyDenomination" + parameter);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
