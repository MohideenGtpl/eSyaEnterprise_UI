...
function fnLoadDocumentTypeGrid() {
    ...
    }).jqGrid('navGrid', '#jqpDocumentType', { add: false, edit: false, search: false, del: false, refresh: false })
        .jqGrid('navButtonAdd', '#jqpDocumentType', {
    ...
    $("#jqgDocumentType").jqGrid('inlineNav', '#jqpDocumentType', {
        addParams: { position: "last" },
        edit: true,
        edittext: "Edit",
        add: true,
