#pragma checksum "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\DoctorScheduler\Views\Appointment\_Confirmation.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e0d3e72bfb9d2ecc44db11ac67ba1a67736a72a7"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e0d3e72bfb9d2ecc44db11ac67ba1a67736a72a7", @"/Areas/DoctorScheduler/Views/Appointment/_Confirmation.cshtml")]
...
<div class=""row blur"">
    ...
    <div class=""col-lg-12 col-md-12 col-sm-12"">
      ...
      ");
            WriteLiteral(@"                  <option disabled>Choose Episode</option>
   ...
   ");
            ...
            WriteLiteral(@"                    </select>
                ...
                <div class=""col-lg-6 col-md-6 col-sm-6 form-group"">
                    ...
                    ");
            EndContext();
            BeginContext(5030, 74, false);
#line 104 "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\DoctorScheduler\Views\Appointment\_Confirmation.cshtml"
               Write(await Component.InvokeAsync("IsdMobileInput", new { id = "MobileNumber" }));

#line default
#line hidden
            EndContext();
            BeginContext(5104, 1393, true);
            WriteLiteral(@"
                </div>
                <div class=""col-lg-6 col-md-6 col-sm-6 form-group"">
    ...
    $(document).ready(function () {
        $(""#cboApptPatientSearch"").autocomplete({
            ...
            select: function (event, ui) {
                $('#txtU");
            WriteLiteral(@"HID').val(ui.item.HospitalNumber);
        ...
        $.get(getBaseURL() + '/Appointment/GetReferredBy',
            function (data) {
                ...
                $(""#cboRef");
            WriteLiteral(@"erredBy"").selectpicker('refresh');
            });
  ...
  ");
        ...
        $.ajax({
            ...
            WriteLiteral(@"tpicker('refresh');
                ...
                if (result.IsSponsored) {
                    ...
                    $('#cboCustomer').val("""");
                    $(");
            WriteLiteral(@"""#cboCustomer"").attr('disabled', true);
                }
    ...
    function fnSaveAppointmentConfirmation() {
        ...
        try {
            ...
            var obj = {
                BusinessK");
            WriteLiteral(@"ey: $(""#cboBusinessLocation"").val(),
    ...
    function IsValid() {
        ...
        else if (IsStringNullorEmpty($(""#txtDateOfBirth"").");
            WriteLiteral(@"val())) {
...
");
            WriteLiteral("            toastr.warning(\"Please select the Request Channel\");\r\n            return false;\r\n        }\r\n        return true;\r\n    }\r\n\r\n\r\n</script>\r\n");
            EndContext();
        }
