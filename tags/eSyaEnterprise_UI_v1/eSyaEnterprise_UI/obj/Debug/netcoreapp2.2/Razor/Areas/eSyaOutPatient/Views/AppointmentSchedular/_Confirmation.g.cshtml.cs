#pragma checksum "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\eSyaOutPatient\Views\AppointmentSchedular\_Confirmation.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "03782eff3463bd9b4d0f0ca1534ea5c26c5efc9f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"03782eff3463bd9b4d0f0ca1534ea5c26c5efc9f", @"/Areas/eSyaOutPatient/Views/AppointmentSchedular/_Confirmation.cshtml")]
...
#line 105 "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\eSyaOutPatient\Views\AppointmentSchedular\_Confirmation.cshtml"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get(getBaseURL() + '/AppointmentSchedular/GetReferredBy',
            function (data) {
                ...
                $");
            WriteLiteral(@"(""#cboReferredBy"").selectpicker('refresh');
            });
    ...
    function fnI");
            WriteLiteral(@"sSponsored_changed() {
  ...
  ");
            WriteLiteral(@"              $('#txtUHID').val(result.UHID);
    ...
    function GetAppointmentPatientDetail(appKey) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.IsSponsored) {
   ");
            WriteLiteral(@"                 $('input[name=""IsSponsored""][value=""S""]').prop('checked', true);
                    $(""#cboCustomer"").attr('disabled', false);
                }
                else {
                    $('input[name=""IsSponsored""][value=""S""]').prop('checked', false);
            ...
            error: function (error) {
                toastr.er");
            WriteLiteral(@"ror(error.statusText);
                return false;
            }
        });
    ...
    function fnSaveAppointmentConfirmation() {
        ...
        try {
            ...
            var obj = {
               ...
               ");
            WriteLiteral(@" ClinicType: $(':selected', $('#cboClinicType')).data('clinictype'),
      ...
      ");
            WriteLiteral(@"          ReferredBy: $('#cboReferredBy').val(),
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.Status) {
                        ...
                        if (_appKey <= 0) {
                            toastr.success(""Appointment Confirmed. Appointment Number : "" + respons");
            WriteLiteral(@"e.QTokenKey);
    ...
    function IsValid() {
        ...
        els");
            WriteLiteral(@"e if (IsStringNullorEmpty($(""#txtLastName"").val())) {
