#pragma checksum "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\eSyaNatureCure\Views\FrontOffice\V_ENC_01_00.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0952ed6addbb0cd4db55df0619c657a0297bf3cc"
// <auto-generated/>
...
#line 1 "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\eSyaNatureCure\Views\FrontOffice\V_ENC_01_00.cshtml"
using Microsoft.Extensions.Configuration;

#line default
#line hidden
#line 3 "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\eSyaNatureCure\Views\FrontOffice\V_ENC_01_00.cshtml"
using Microsoft.AspNetCore.Http;

#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0952ed6addbb0cd4db55df0619c657a0297bf3cc", @"/Areas/eSyaNatureCure/Views/FrontOffice/V_ENC_01_00.cshtml")]
    public class Areas_eSyaNatureCure_Views_FrontOffice_V_ENC_01_00 : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 6 "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\eSyaNatureCure\Views\FrontOffice\V_ENC_01_00.cshtml"
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "0952ed6addbb0cd4db55df0619c657a0297bf3cc4804", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "0952ed6addbb0cd4db55df0619c657a0297bf3cc6056", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
#line 12 "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\eSyaNatureCure\Views\FrontOffice\V_ENC_01_00.cshtml"
...
<script>
    ...
    function fnbuilddashbord() {
        ...
        _tableContent += '<tr><td colspan=""2"">' +
            ...
            '<button type=""button");
            WriteLiteral(@""" class=""btn btn-primary d-none mr-1""><i class="" fa fa-calendar""></i></button>' +
        ...
        for (var v = 0; v < 21; v++) {
            ...
            _tableContent += '<td id=""' + dt + '"" class=""text-center""><span>' + moment(myDate).format(""DD/MM"") + '</span> <");
            WriteLiteral(@"span class=""d-block text-small""> ' + moment(myDate).format(""ddd"") + '</span></td>';
            //}
            ////Wednesday
            //if (myDate.getDay() == 3) {
            //    var dt = (""0"" + (myDate.getDate())).slice(-2) + '/' + (""0"" + (myDate.getMonth() + 1)).slice(-2) + '/' + myDate.getFullYear();
        ...
        for (var a = 0; a < _roomType.length; a++) {
            ...
            for (var b = 0; b < _roomNumber.length; b++) {
                ...
                _roomSubNumber = _roomSubNumber.filter(function (itm, i, _roomSubNumber) {
                    return i =");
            WriteLiteral(@"= _roomSubNumber.indexOf(itm);
                });
                ...
                for (var c = 0; c < _roomSubNumber.length; c++) {
                    ...
                    for (var v = 0; v < 21; v++) {
                        ...
                        var dt = (""0"" + (myDate.getDate())).slice(-2) + '/' + (""0"" + (myDate.getMonth() + 1)).slice(-2) + '/' + myDate.getFullYear();
                        _content += ""<td role='button' data-toggle='popover' data-placement='top' data-trigger='click' data-html='true' data-content='' id="" + _roomType[a].substring(0, 1) + '_' + _roomNumber[b] + _roomSubNumber[c].replace(/\s/g, '')");
            WriteLiteral(@" + '_' + (""0"" + (myDate.getDate())).slice(-2) + ""></td>"";
                        //  }
                    }
                    _content += ""</tr > "";
    ...
    function loadBookingData() {
        ...
        $.ajax({
            url: getBaseURL() + '/FrontOffic");
            WriteLiteral(@"e/GetDashboardByDate?fromDate=' + $(""#txtfromdate"").val() + '&toDate=' + $(""#txtfromdate"").val(),
            type: 'GET',
        ...
        $.each(act_occu, function (key, booking) {
            ...
            //$(_id).html(""<span class='bookedBar three' data-toggle='popover' data-placement='top' onclick=fnGetGuestDetails('"" + booking.BookingKey + ""','"" + booking.GuestId +""','""+ _id + ""') data-html='true' data-content='' data-name='"" + booking.GuestName + ""'><p class=");
            WriteLiteral(@"'m-0'>"" + booking.GuestName + ""</p><p class='text-small m-0'>"" + booking.MobileNumber + ""</p></span>"");
    ...
    function fnGetGuestDetails(_bookingkey, _guestid, _id) {
        ...
        $.each(act_occu, function (key, booking) {
            if (booking.BookingKey == _bookingkey && booking.GuestId == _guestid) {
                ...
                $('#txtCheckout').html(bookin");
            WriteLiteral(@"g.CheckOutDate.slice(0, 10).split('-').reverse().join('-'))
    ...
    function fnSetCurrentdate() {
        ...
        document.getElementById(""txttodate"").va");
            WriteLiteral(@"lue = today;
        fnbuilddashbord();
        loadBookingData();
    }
</script>
<script>
    ...
    $("".popover-header"").append('<a href=""#"" class=""close d-flex justify-content-end ");
            WriteLiteral(@"align-items-center h-100"" data-dismiss=""alert""><i class=""fa fa-times""></i></a>');
    ...
    function fnRedirectToGuestPortal() {
        ...
        var baseUrl = ");
            EndContext();
            BeginContext(17592, 65, false);
#line 359 "D:\eSya Project\Solution\eSyaEnterprise_UI\tags\eSyaEnterprise_UI_v1\eSyaEnterprise_UI\Areas\eSyaNatureCure\Views\FrontOffice\V_ENC_01_00.cshtml"
                 Write(Json.Serialize(@Configuration.GetSection("GuestPortalURL").Value));

#line default
#line hidden
            EndContext();
            BeginContext(17657, 93, true);
