...
namespace eSyaEnterprise_UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                p.BaseAddress = new Uri(Configuration.GetValue<string>("eSyaLocalization_API"));
                p.DefaultRequestHeaders.Add("dbContextType", Configuration.GetValue<string>("dbContextType"));
                p.DefaultRequestHeaders.Add("Apikey", Configuration.GetValue<string>("Apikey"));
            });
            ...
            {
                p.BaseAddress = new Uri(Configuration.GetValue<string>("eSyaTokenSystem_API"));
                p.DefaultRequestHeaders.Add("dbContextType", Configuration.GetValue<string>("dbContextType"));
                p.DefaultRequestHeaders.Add("Apikey", Configuration.GetValue<string>("Apikey"));
            });
            ...
            {
                p.BaseAddress = new Uri(Configuration.GetValue<string>("eSyaInventory_API"));
                p.DefaultRequestHeaders.Add("dbContextType", Configuration.GetValue<string>("dbContextType"));
                p.DefaultRequestHeaders.Add("Apikey", Configuration.GetValue<string>("Apikey"));
            });
            services.AddHttpClient<IStoreAPIServices, StoreAPIServices>(p =>
            {
                p.BaseAddress = new Uri(Configuration.GetValue<string>("eSyaStore_API"));
                p.DefaultRequestHeaders.Add("dbContextType", Configuration.GetValue<string>("dbContextType"));
                p.DefaultRequestHeaders.Add("Apikey", Configuration.GetValue<string>("Apikey"));
            });
