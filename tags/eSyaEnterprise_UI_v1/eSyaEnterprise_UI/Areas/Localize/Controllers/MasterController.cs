...
namespace eSyaEnterprise_UI.Areas.Localize.Controllers
{
    ...
    public class MasterController : Controller
    {
        ...
        public async Task<JsonResult> GetLocalizationTableMaster()
        {
            try
            {
                var serviceResponse = await _localizeAPIServices.HttpClientServices.GetAsync<List<DO_LocalizationMaster>>("Master/GetLocalizationTableMaster");
        ...
        public async Task<JsonResult> InsertOrUpdateLocalizationTableMaster(DO_LocalizationMaster obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _localizeAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("Master/InsertOrUpdateLocalizationTableMaster", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
        ...
        public async Task<JsonResult> ActiveOrDeActiveLocalizationTableMaster(bool status, int Tablecode)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _localizeAPIServices.HttpClientServices.GetAsync<DO_ReturnParameter>("Master/ActiveOrDeActiveLocalizationTableMaster" + parameter);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<IActionResult> ELE_02_00()
        {
            ...
            try
            {
                ...
                var servicetableResponse = await _localizeAPIServices.HttpClientServices.GetAsync<List<DO_LocalizationMaster>>("Master/GetLocalizationMaster");
        ...
        public async Task<JsonResult> InsertOrUpdateLocalizationLanguageMapping(List<DO_LocalizationLanguageMapping> l_obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _localizeAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("Master/InsertOrUpdateLocalizationLanguageMapping", l_obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> GetLocalizationLanguageMapping(string languageCode, int tableCode)
        {
            try
            {
                if (tableCode > 0)
                {
                    ...
                    var serviceResponse = await _localizeAPIServices.HttpClientServices.GetAsync<List<DO_LocalizationLanguageMapping>>("Master/GetLocalizationLanguageMapping" + parameter);
                    return Json(serviceResponse.Data);
                }
                else
                    return Json(null);
