...
namespace eSyaEnterprise_UI.Areas.eSyaPayrollExpat.Controllers
{
    ...
    public class BankMasterController : Controller
    {
        ...
        /// </summary>
        [HttpPost]
        public async Task<JsonResult> GetBankMasterByBusinessKey(int businesskey)
        {
            try
            {
                var parameter = "?businesskey=" + businesskey;
                var serviceResponse = await _eSyaPayrollExpatAPIServices.HttpClientServices.GetAsync<List<DO_BankMaster>>("BankMaster/GetBankMasterByBusinessKey" + parameter);
        ...
        /// </summary>
        [HttpPost]
        public async Task<JsonResult> GetBankCurrencyByBusinessKey(int businesskey,string BankCode)
        {
            try
            {
                ...
                var parameter = "?businesskey=" + businesskey + "&BankCode=" + BankCode;
                var bankserviceResponse = await _eSyaPayrollExpatAPIServices.HttpClientServices.GetAsync<List<DO_BankCurrency>>("BankMaster/GetBankCurrencyByBusinessKey" + parameter);
