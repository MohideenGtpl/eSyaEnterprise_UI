...
namespace eSyaEnterprise_UI.Areas.eSyaNatureCure.Controllers
{
    public class CheckInGuestController : Controller
    {
        ...
        public CheckInGuestController(IeSyaNatureCureAPIServices eSyaNatureCureAPIServices, ISmsServices smsServices, ILogger<CheckInGuestController> logger, IHostingEnvironment hostingEnvironment)
        {
        ...
        public void SendSMSForGuestCheckIn(DO_GuestCheckInDetails obj)
        {
            try
            {
               DO_SmsParameter smsParams = new DO_SmsParameter();
                smsParams.MessageType = "NGC";
                smsParams.TEventID = SMSTriggerEventValues.OnGuestCheckIn;
                smsParams.FormID = 10004;//AppSessionVariables.GetSessionFormID(HttpContext);
                smsParams.MobileNumber = obj.MobileNumber;
                smsParams.Name = obj.FirstName + " " + obj.LastName;
