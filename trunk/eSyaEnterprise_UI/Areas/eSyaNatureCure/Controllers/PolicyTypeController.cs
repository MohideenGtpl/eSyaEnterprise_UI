...
namespace eSyaEnterprise_UI.Areas.eSyaNatureCure.Controllers
{
    ...
    public class PolicyTypeController : Controller
    {
        ...
        /// </summary>
        [HttpPost]
        public async Task<JsonResult> ActiveOrDeActivePolicyType(bool status, int policytypeId, int serialNo)
        {

            try
            {

                var parameter = "?status=" + status + "&policytypeId=" + policytypeId + "&serialNo=" + serialNo;
