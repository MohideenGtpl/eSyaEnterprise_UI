...
namespace eSyaEnterprise_UI.Areas.FixedAssets.Controllers
{
    ...
    public class AssetRegisterController : Controller
    {
        ...
        public AssetRegisterController(IFixedAssetsAPIServices FixedAssetsAPIServices)
        {
        ...
        public JsonResult InsertAssetRegisterHeader(DO_AssetRegister obj)
        {
            ...
            try
            {
                ...
                var result = _FixedAssetsAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("AssetRegister/InsertAssetRegisterHeader", obj).Result;
        ...
        {
            var response = _FixedAssetsAPIServices.HttpClientServices.GetAsync<List<DO_AssetRegisterDetail>>("AssetRegister/GetAssetRegisterDetail?businessKey=" + AppSessionVariables.GetSessionBusinessKey(HttpContext) + "&internalAssetANumber=" + internalAssetnumber).Result;
        ...
        public JsonResult InsertUpdateAssetRegisterDetail(DO_AssetRegisterDetail obj)
        {
            ...
            try
            {
                ...
                var result = _FixedAssetsAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("AssetRegister/InsertUpdateAssetRegisterDetail", obj).Result;
                return Json(result.Data);
            }
            catch (Exception ex)
            {
        ...
        {
            var response = _FixedAssetsAPIServices.HttpClientServices.GetAsync<List<DO_AssetRegister>>("AssetRegister/GetAssetRegisterHeaderList?businessKey=" + AppSessionVariables.GetSessionBusinessKey(HttpContext)).Result;
        ...
        {
            var response = _FixedAssetsAPIServices.HttpClientServices.GetAsync<DO_AssetRegister>("AssetRegister/GetAssetRegisterHeader?businessKey=" + AppSessionVariables.GetSessionBusinessKey(HttpContext) + "&internalAssetANumber=" + internalAssetnumber).Result;
        ...
        public JsonResult UpdateAssetRegisterHeader(DO_AssetRegister obj)
        {
            try
            {
                ...
                var result = _FixedAssetsAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("AssetRegister/UpdateAssetRegisterHeader", obj).Result;
                return Json(result.Data);
            }
            catch (Exception ex)
            {
