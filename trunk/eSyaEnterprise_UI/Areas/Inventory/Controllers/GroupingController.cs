    ...
    public class GroupingController : Controller
    {
        ...
        public async Task<ActionResult> LoadItemSubCategoryTree()
        {
            try
            {
                ...
                treeView.Add(jsObj);
                var serviceResponse = await _inventoryAPIServices.HttpClientServices.GetAsync<List<DO_ItemCategory>>("ItemControl/GetItemCategory");
                var Subcategory_res = await _inventoryAPIServices.HttpClientServices.GetAsync<List<DO_ItemSubCategory>>("ItemControl/GetItemSubCategories");
        ...
        public async Task<ActionResult> LoadItemGroupCateSubCateTree()
        {
            try
            {
                ...
                var serviceResponse = await _inventoryAPIServices.HttpClientServices.GetAsync<List<DO_ItemGroup>>("ItemControl/GetItemGroup");
                var serviceResponse1 = await _inventoryAPIServices.HttpClientServices.GetAsync<List<DO_ItemCategory>>("ItemControl/GetItemCategoriesByItemGroup");
                var serviceResponse2 = await _inventoryAPIServices.HttpClientServices.GetAsync<List<DO_ItemSubCategory>>("ItemControl/GetItemSubCategoriesByItemGroupCategory");
