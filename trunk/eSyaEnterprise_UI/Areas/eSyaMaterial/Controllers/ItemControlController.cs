...
namespace eSyaEnterprise_UI.Areas.eSyaMaterial.Controllers
{
    ...
    public class ItemControlController : Controller
    {
        ...
        public async Task<IActionResult> V_1001_00()
        {
            //ViewBag.UserFormRoles = new DO_UserFormRole { IsInsert = true, IsEdit = true, IsDelete = true , IsView = false};
            return View();
        }
        ...
        [Area("eSyaMaterial")]
        [ServiceFilter(typeof(ViewBagActionFilter))]
        public async Task<IActionResult> V_1002_00()
        {
        ...
        [Area("eSyaMaterial")]
        [ServiceFilter(typeof(ViewBagActionFilter))]
        public async Task<IActionResult> V_1003_00()
        {
            //ViewBag.UserFormRoles = new DO_UserFormRole { IsInsert = true, IsEdit = true, IsDelete = true, IsView = true };
            return View();
        }
        ...
        [Area("eSyaMaterial")]
        [ServiceFilter(typeof(ViewBagActionFilter))]
        public async Task<IActionResult> V_1004_00()
        {
            ...
            var serviceResponse1 = await _eSyaMaterialAPIServices.HttpClientServices.GetAsync<List<DO_ItemGroup>>("ItemControl/GetItemGroup");
