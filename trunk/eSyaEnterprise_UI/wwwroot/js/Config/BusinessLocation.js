...
function fnGridLoadBusinessLocation() {
    ...
    $("#jqgBusienssLocation").jqGrid({
        ...
        colModel: [
            ...
            { name: "LocationCode", width: 50, align: 'left', editable: true, editoptions: { maxlength: 50 }, resizable: false },
            { name: "LocationDescription", width: 180, align: 'left', editable: true, editoptions: { maxlength: 50 }, resizable: false },
            { name: "BusinessName", width: 180, align: 'left', editable: true, editoptions: { maxlength: 50 }, resizable: false },
