...
function fnGridLoadMemberShipCard() {
    ...
    $("#jqgMemberShipCard").jqGrid({
        ...
        colNames: [localization.PackageId, localization.MembershipType, localization.RoomType, localization.RoomType,localization.DonationRangeFrom, localization.DonationRangeTo, localization.BookingDiscountPercentage, localization.NoOfPersons, localization.Active, localization.Actions],
        colModel: [
...
function fnSaveMemberShipCard() {
    ...
    if (IsStringNullorEmpty($("#cboMemberShipType").val()) || $("#cboMemberShipType").val() === '0' || $("#cboMemberShipType").val() === "0") {
        toastr.warning("Please select MemberShip Type");
        return;
    }
