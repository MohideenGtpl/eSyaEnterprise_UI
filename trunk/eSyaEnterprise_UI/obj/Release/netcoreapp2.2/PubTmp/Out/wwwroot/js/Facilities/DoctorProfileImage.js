...
click_button.addEventListener('click', function () {
    ...
    document.getElementById('imgPhoto').innerHTML = '<img id="imgPhotoimageblah" src=" ' + image_data_url + '"  alt="Doctor Image"/> <input class="fileInput" id="FileUpload1" type="file" name="file" onchange="readPhotoimage(this);" accept="image/*" enctype="multipart/form-data" style="visibility:hidden" />';
    stream.off();
});
...
function fnFillDoctorImageData(data) {
    ...
    if (data.DoctorProfileImage !== null && data.DoctorProfileImage !== "") {
        ...
        document.getElementById('imgPhoto').innerHTML = '<img id="imgPhotoimageblah" src=" ' + data.DoctorProfileTitle + '"  alt=" &nbsp; Doctor Image"   /> <input class="fileInput" id="FileUpload1" type="file" name="file" onchange="readPhotoimage(this);" accept="image/*" enctype="multipart/form-data" style="visibility:hidden" />';
    }
