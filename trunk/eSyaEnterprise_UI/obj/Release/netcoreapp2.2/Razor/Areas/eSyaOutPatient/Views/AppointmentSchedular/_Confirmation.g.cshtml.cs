#pragma checksum "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\eSyaOutPatient\Views\AppointmentSchedular\_Confirmation.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ea59a3fa1a57f0caf7f91982c53c98b1a01dd98d"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_eSyaOutPatient_Views_AppointmentSchedular__Confirmation), @"mvc.1.0.view", @"/Areas/eSyaOutPatient/Views/AppointmentSchedular/_Confirmation.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Areas/eSyaOutPatient/Views/AppointmentSchedular/_Confirmation.cshtml", typeof(AspNetCore.Areas_eSyaOutPatient_Views_AppointmentSchedular__Confirmation))]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ea59a3fa1a57f0caf7f91982c53c98b1a01dd98d", @"/Areas/eSyaOutPatient/Views/AppointmentSchedular/_Confirmation.cshtml")]
    public class Areas_eSyaOutPatient_Views_AppointmentSchedular__Confirmation : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(120, 2979, true);
            WriteLiteral(@"
<style>
        ...
        <section class=""AppointmentSectionBox"">
            <div class=""row rowBox p-y-10"">
                ...
                <div class=""col-lg-6 col-md-6"">
                    ...
                    <label class=""c-grey specialty"" id=""lblDoctorQualification""");
            WriteLiteral(@"></label>
                </div>
                <div class=""col-lg-5 col-md-4 col-sm-7 border-left"">
        ...
        <section class=""AppointmentSectionBox"">
            <div class=""row padtop10"">
                <div class=""col-lg-6 col-md-6 col-sm-6 form-group"">
                    <label>Episode</label>
                    <select class=""form-control"" id=""cboVisitType"" disabled>
  ");
            WriteLiteral(@"                      <option>Choose Episode</option>
                        <option value=""N"" selected>New Consultation</option>
                        <option value=""R"">Follow-Up - Nutrition</option>
                        <option value=""S"">Follow-Up - Surgical</option>
                    </select>
                </div>
   ...
   ");
            ...
            WriteLiteral(@"                    </select>
                ...
                <div class=""col-lg-6 col-md-6 col-sm-6 form-group"">
                    ...
                    ");
            EndContext();
            BeginContext(5110, 74, false);
#line 105 "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\eSyaOutPatient\Views\AppointmentSchedular\_Confirmation.cshtml"
               Write(await Component.InvokeAsync("IsdMobileInput", new { id = "MobileNumber" }));

#line default
#line hidden
            EndContext();
            BeginContext(5184, 1393, true);
            WriteLiteral(@"
                </div>
                <div class=""col-lg-6 col-md-6 col-sm-6 form-group"">
...
<script>
    ...
    $(document).ready(function () {
        $(""#cboApptPatientSearch"").autocomplete({
            ...
            WriteLiteral(@" $('#txtUHID').val(ui.item.HospitalNumber);
                ...
                $('#cboMobileNumber').val(ui.item.ISDCode);
        ...
        $.get(getBaseURL() + '/AppointmentSchedular/GetReferredBy',
            function (data) {
                var s = '<option value=""-1"">select</option>';
                for (var i = 0; i < data.length; i++) {
                    s += '<option value=""' + data[i].ApplicationCode ");
            WriteLiteral(@"+ '"" >' + data[i].CodeDesc + '</option>';
                }
    ...
    function fnShowAppointmentConfirmation() {
        ...
        $('#cboVisitType').val($(':selected', $('#cboClinicType')).data('consultationtypecode'));
        $('#cboVisitType').selectpicker('refresh');
    ...
    function GetAppointmentPatientDetail(appKey) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('#cboVisitType').val(result.EpisodeType);
                $('#cboVisitType').selectpicker('refresh');
                ...
                $('#cboMobileNumber').val(result.Isdcode);
                $('#cboMobileNumber').selectpicker('refresh');
                ...
                if (result.IsSponsored) {
                    $('input");
            WriteLiteral(@"[name=""IsSponsored""][value=""S""]').prop('checked', true);
                    $(""#cboCustomer"").attr('disabled', false);
                }
                else {
                    $('input[name=""IsSponsored""][value=""S""]').prop('checked', false);
    ...
    //            $('#txtLastName').val(result.PatientLastName);
    //            $('#cboGender')");
            WriteLiteral(@".val(result.Gender);
    //            $('#txtDateOfBirth').val(fnFormatDateJsonToInput(new Date(result.DateOfBirth)));
    //            $('#cboMobileNumber').val(result.ISDCode);
    //            $('#cboMobileNumber').selectpicker('refresh');
    //            $('#txtMobileNumber').val(result.PatientMobileNumber);
    ...
    //            $('#cboCustomer').val(result.CustomerID);
    //         ");
            WriteLiteral(@"   $('#cboCustomer').selectpicker('refresh');
    ...
    function fnSaveAppointmentConfirmation() {
        ...
        try {
            ...
            var obj = {
                ...
                ClinicId");
            WriteLiteral(@": $(':selected', $('#cboClinicType')).data('clinictype'),
            ...
            WriteLiteral(@": URL,
                ...
                success: function (response) {
                    ...
                    if (response.Status) {
                        ...
                        if (_appKey <= 0) {
                            toastr.success(""Appointment Confirmed. Appointment Number : "" + response.QTokenKey);
   ...
   ");
        ...
        else if (IsStringNullorEmpty($(""#cboMobileNumber"").val() || $(""#cboMobileNumber"").val() === ""0"")) {          
