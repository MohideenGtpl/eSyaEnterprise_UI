#pragma checksum "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\eSyaNatureCure\Views\FrontOffice\V_ENC_02_00.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a0107b3afcf45d854dfa954bb1611598162c9040"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a0107b3afcf45d854dfa954bb1611598162c9040", @"/Areas/eSyaNatureCure/Views/FrontOffice/V_ENC_02_00.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "a0107b3afcf45d854dfa954bb1611598162c90403957", async() => {
            }
            );
        ...
        $.ajax({
            ...
            WriteLiteral(@"  $(""#jqgCheckoutDetail"").jqGrid({
                    ...
                    colModel: [
                        ...
                        { name: ""MobileNumber"", width: 120, editable: true, align: 'left', hidden: false },
                        {
                            name: ""CheckInDate"", editable: false, width: 120, align: 'left', formatter: 'date', formatoptions: { newformat: _cnfjqgDateFormat }
            ...
            WriteLiteral(@"', hidden: false, formatter: function (cellValue, options, rowObject) {
                                var i = options.rowId;
                                return ""<button id=btnCheckout_"" + i + "" type='button'  class='btn btn-primary' onclick=fnGuestCheckin('"" + rowObject.BookingKey + ""','"" + rowObject.GuestId + ""') >  Check-Out </button >"";
                            }
                        },
                    ],
        ...
        ");
                ...
                if (response.PendingCheckin_List != null) {
                    ...
                    $(""#jqgPendingCheckIn"").jqGrid({
                        ...
                        colModel: [
                            ...
                            { name: ""GuestId"", width: 50, editable: true, align: 'left', hidden: true },
                            { name: ""GuestName"", width: 120, editable: true, align: 'left', hidden: false },
                            { name: ""MobileNumber"", width: 120, editable: true, align: 'left', hidden: fals");
            WriteLiteral(@"e },
                            {
            ...
            WriteLiteral(@",
                ...
                $(""#jqgActOccuDetail"").jqGrid({
                    ...
                    colModel: [
                        { name: ""BookingKey"", width: 50, editable: true, align: 'left', h");
...
");
            WriteLiteral(@"    function fnGuestCheckin(bookingKey, guestId) {
    ...
    function fnSetGridWidth() {
        $('[id^=jqg]').jqGrid('setGridWidth', $("".tab-content"").width());
    }
</script>
");
            EndContext();
