#pragma checksum "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\Facilities\Views\Doctors\_SpecialtyLink.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e382d75fcd2d97a8d6e663a6ad15bd17f717b583"
// <auto-generated/>
...
#line 5 "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\Facilities\Views\Doctors\_SpecialtyLink.cshtml"
using Microsoft.AspNetCore.Mvc.Localization;

#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e382d75fcd2d97a8d6e663a6ad15bd17f717b583", @"/Areas/Facilities/Views/Doctors/_SpecialtyLink.cshtml")]
...
#line 16 "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\Facilities\Views\Doctors\_SpecialtyLink.cshtml"
                                  Write(Localizer["Location"]);

#line default
#line hidden
            EndContext();
            BeginContext(731, 327, true);
            WriteLiteral(@"</label>
...
#line 23 "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\Facilities\Views\Doctors\_SpecialtyLink.cshtml"
                                  Write(Localizer["Specialty"]);

#line default
#line hidden
            EndContext();
            BeginContext(1081, 534, true);
            WriteLiteral(@"</label>
...
#line 31 "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\Facilities\Views\Doctors\_SpecialtyLink.cshtml"
...
#line hidden
    ...
    <div class=""col-lg-2 col-md-3 col-sm-6 form-group d-flex align-items-end"">
        <button type=""button"" class=""mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect"" id=""btnDoctorSpecialtySave"" onclick=""fnSaveDoctorSpecialtyLink()""><i class=""fa fa-save""></i> ");
            EndContext();
            BeginContext(1971, 17, false);
#line 36 "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\Facilities\Views\Doctors\_SpecialtyLink.cshtml"
                                                                                                                                                                                               Write(Localizer["Save"]);

#line default
#line hidden
            EndContext();
            BeginContext(1988, 545, true);
            WriteLiteral(@"</button>
    </div>
</div>
<div class=""row"">
...
#line 49 "D:\eSya Project\Solution\eSyaEnterprise_UI\trunk\eSyaEnterprise_UI\Areas\Facilities\Views\Doctors\_SpecialtyLink.cshtml"
                                                                                                                                                                                                                Write(Localizer["Back"]);

#line default
#line hidden
            EndContext();
            BeginContext(2551, 12729, true);
            WriteLiteral(@"</button>
...
<script>
    ...
    function fnGridDoctorSpecialtyLink() {
        ...
        $(""#jqgDoctorSpecialtyLink"").jqGrid(
            {
             ");
            WriteLiteral(@"   url: getBaseURL() + '/Doctors/GetSpecialtyListByDoctorId?doctorId=' + $('#txtDoctorId').val(),
                datatype: 'json',
                mtype: 'POST',
                ...
                colModel: [
                    ...
                    {
                        name: 'ActiveStatus', index: 'ActiveStatus', width: 70, resizable: false, align: 'center', formatter: ""checkbox"", edittype: ""checkbox"", editoptions: { value: ""tr");
  ...
  ");
    ...
    function fnDeleteSpecialty(e) {
        ...
        if (rowData != null) {
            ...
            $.ajax({
                url: getBaseURL() + '/Doctors/UpdateDoctorSpecia");
            WriteLiteral(@"ltyLink',
                type: 'POST',
                datatype: 'json',
                data: { obj },
    ...
    function fnLoadSpecialty() {
        $('#cboSpecialty').selectpicker('refresh');
        $.ajax({
            url: getBaseURL() + '/Facilities/Specialty/GetSpecialtyListForBusinessKey?busi");
            WriteLiteral(@"nessKey=' + $('#cboLocation').val(),
            type: 'POST',
            datatype: 'json',
            async: false,
            success: function (response) {
    ...
    function fnSaveDoctorSpecialtyLink() {
        ...
        //alert($('#chkSpeci");
            WriteLiteral(@"altyActiveStatus').parent().hasClass(""is-checked""));
    ...
    function fnBindDoctorLocationb");
            WriteLiteral(@"yDoctorId() {
        $('#cboLocation').selectpicker('refresh');
                $.ajax({
                    type: ""Post"",
                    ...
                    success: function (data) {
                        ...
                        if ($('#cboLocation option').length == 2) {
                            ...
                            $(""");
            WriteLiteral(@"#cboLocation"").val($('#cboLocation option:first').val());
                            $('#cboLocation').selectpicker('refresh');
                        }
