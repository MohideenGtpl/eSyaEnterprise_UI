...
namespace eSyaEnterprise_UI.Areas.Configure.Controllers
{
    ...
    public class RulesController : Controller
    {
        ...
        public async Task<JsonResult> GetProcessMaster()
        {
            try
            {
                var serviceResponse = await _configAPIServices.HttpClientServices.GetAsync<List<DO_ProcessMaster>>("ProcessMaster/GetProcessMaster");
        ...
        public async Task<JsonResult> GetProcessRule()
        {
            try
            {
                var serviceResponse = await _configAPIServices.HttpClientServices.GetAsync<List<DO_ProcessRule>>("ProcessMaster/GetProcessRule");
                if (serviceResponse.Status)
                {
                    return Json(serviceResponse.Data);
        ...
        public async Task<JsonResult> InsertProcessMaster(DO_ProcessMaster obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("ProcessMaster/InsertIntoProcessMaster", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
        ...
        public async Task<JsonResult> UpdateProcessMaster(DO_ProcessMaster obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("ProcessMaster/UpdateProcessMaster", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> InsertApplicationRule(DO_ProcessRule obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("ProcessMaster/InsertIntoProcessRule", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> UpdateApplicationRule(DO_ProcessRule obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("ProcessMaster/UpdateProcessRule", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> GetProcessRulebySegmentwise()
        {
            try
            {
                var serviceResponse = await _configAPIServices.HttpClientServices.GetAsync<List<DO_ProcessRule>>("ProcessMaster/GetProcessRulebySegmentwise");
                if (serviceResponse.Status)
                {
                    return Json(serviceResponse.Data);
        ...
        public async Task<JsonResult> GetProcessRulebyBusinessKey(int BusinessKey)
        {
            try
            {
                var serviceResponse = await _configAPIServices.HttpClientServices.GetAsync<List<DO_ProcessRule>>("ProcessMaster/GetProcessRulebyBusinessKey?BusinessKey=" + BusinessKey);
                if (serviceResponse.Status)
                {
                    return Json(serviceResponse.Data);
        ...
        public async Task<JsonResult> InsertorUpdateProcessRulebySegment(DO_ProcessRulebySegment obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _configAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("ProcessMaster/InsertorUpdateProcessRulebySegment", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
