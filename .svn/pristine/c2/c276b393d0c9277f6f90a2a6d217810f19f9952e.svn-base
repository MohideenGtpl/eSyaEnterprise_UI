...
namespace eSyaEnterprise_UI.Areas.eSyaMaterial.Controllers
{
    ...
    public class ItemManagementController : Controller
    {
        ...
        public async Task<JsonResult> GetCustodianStoreListbyAccountingStore(int Businesskey, int Itemcode, int accountingcode)
        {
            try
            {
                var serviceResp = await _eSyaMMAPIServices.HttpClientServices.GetAsync<List<DO_StoreMaster>>("Common/GetCustodianStore");
                ...
                var serviceResponse = await _eSyaMMAPIServices.HttpClientServices.GetAsync<List<DO_StoreMaster>>("ItemCodes/GetCustodianStoreListbyAccountingStore" + parameter);
        ...
        public async Task<JsonResult> InsertOrUpdateItemCodetoCustodianStore(List<DO_ItemCodeLinkCustodianStore> obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaMMAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("ItemCodes/InsertOrUpdateItemCodetoCustodianStore", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<IActionResult> GetAccountingStoreForItem(int businesskey, int itemcode, string accountingType)
        {
            try
            {
                ...
                var serviceResponse = await _eSyaMMAPIServices.HttpClientServices.GetAsync<List<DO_ItemAccountingStore>>("ItemCodes/GetAccountingStoreForItem" + parameter);
                if (serviceResponse.Status)
                {
                    if (serviceResponse.Data != null)
                    {
        ...
        public async Task<JsonResult> InsertAccountingStoreForItem(List<DO_ItemAccountingStore> obj)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaMMAPIServices.HttpClientServices.PostAsJsonAsync<DO_ReturnParameter>("ItemCodes/InsertAccountingStoreForItem", obj);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
