...
function fnGridLoadCounterMapping() {
    ...
    $("#jqgCounterMapping").jqGrid({
        ...
        colNames: [localization.BusinessKey, localization.TokenType, localization.FloorId, localization.CounterNumber, localization.Floor, localization.Token, localization.Active, localization.Actions],
        colModel: [
...
function fnSaveCounterMapping() {
    ...
    if (IsStringNullorEmpty($("#cboCounterNumber").val()) || $("#cboCounterNumber").val() === "0") {
        toastr.warning("Please select Counter Number");
        return;
    }
