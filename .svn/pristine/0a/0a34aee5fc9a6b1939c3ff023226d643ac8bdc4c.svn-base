...
function fnViewBill(appKey) {
    var URL = getReportBaseURL() + '/eSyaClinic/ReportViewer/ConsultationBill?businessKey=587&appointmentKey=' + appKey;
