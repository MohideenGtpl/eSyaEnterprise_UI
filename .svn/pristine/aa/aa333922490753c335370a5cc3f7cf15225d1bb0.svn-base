...
namespace eSyaEnterprise_UI.Areas.Customer.Controllers
{
    ...
    public class CustomerAttributesController : Controller
    {
        ...
        private readonly ILogger<CustomerAttributesController> _logger;
        public CustomerAttributesController(ICustomerAPIServices eSyaCustomerAPIServices, ILogger<CustomerAttributesController> logger)
        {
        ...
        public async Task<IActionResult> ECC_01_00()
        {
            try
            {
        ...
        [Area("Customer")]
        [ServiceFilter(typeof(ViewBagActionFilter))]
        public IActionResult ECC_02_00()
        {
            try
            {
