...
namespace eSyaEnterprise_UI.Areas.eSyaNatureCure.Controllers
{
    ...
    public class DepartmentClearanceController : Controller
    {
        ...
        /// <summary>
        /// Department Clearence
        /// </summary>
        /// <returns></returns>

        [Area("eSyaNatureCure")]
        [ServiceFilter(typeof(ViewBagActionFilter))]
        public IActionResult V_ENC_26_00()
        {

            return View();
        }
        [HttpPost]
        public async Task<JsonResult> GetDepartmentClearencePreviousCheckoutdetails( )
        {
            ...
            try
            {
                ...
                int businesskey = AppSessionVariables.GetSessionBusinessKey(HttpContext);
                var serviceResponse = await _eSyaNatureCureAPIServices.HttpClientServices.GetAsync<List<DO_DepartmentClearenceDetails>>("DepartmentClearance/GetDepartmentClearencePreviousCheckoutdetails?businesskey=" + businesskey);
            ...
            {
                _logger.LogError(ex, "UD:GetDepartmentClearenceDetails");
                return Json(new DO_ReturnParameter() { Status = false, Message = (ex.InnerException != null) ? ex.InnerException.Message : ex.Message });
            }
        }

        [HttpPost]
        public async Task<JsonResult> GetDepartmentClearenceCurrentCheckoutdetails()
        {
            ...
            try
            {
                ...
                int businesskey = AppSessionVariables.GetSessionBusinessKey(HttpContext);
                var serviceResponse = await _eSyaNatureCureAPIServices.HttpClientServices.GetAsync<List<DO_DepartmentClearenceDetails>>("DepartmentClearance/GetDepartmentClearenceCurrentCheckoutdetails?businesskey=" + businesskey);
