    ...
    public class GuestBookingController : Controller
    {
           ...
           string roomNumber, string bedNumber, string occupancyType, string gender, DateTime? bookingFrom, DateTime? bookingTo, DateTime? checkInDate, DateTime? checkOutDate, bool isOnCheckInOutDate)
        {
            ...
            try
            {
                ...
                obj.CheckOutDate = checkOutDate;
                obj.isOnCheckInOutDate = isOnCheckInOutDate;
        ...
        [HttpPost]
        public async Task<JsonResult> GetGuestBookingPaymentFailedDetails(int roomTypeId,
         string roomNumber, string bedNumber, string occupancyType, string gender, DateTime? bookingFrom, DateTime? bookingTo, DateTime? checkInDate, DateTime? checkOutDate, bool isOnCheckInOutDate)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaNatureCureAPIServices.HttpClientServices.PostAsJsonAsync<List<DO_GuestBooking>>("GuestBooking/GetGuestBookingPaymentFailedDetails", obj);
            ...
            {
                _logger.LogError(ex, "UD:GetGuestBookingPaymentFailedDetails:For roomTypeId {0} ", roomTypeId);
                return Json(new DO_ReturnParameter() { Status = false, Message = (ex.InnerException != null) ? ex.InnerException.Message : ex.Message });
            }
        }
