    ...
    public class LocalizationController : Controller
    {
        ...
        public async Task<JsonResult> ActiveOrDeActiveLocalizationTableMaster(bool status, int Tablecode)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaConfigAPIServices.HttpClientServices.GetAsync<DO_ReturnParameter>("Localization/ActiveOrDeActiveLocalizationTableMaster" + parameter);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
        ...
        public async Task<JsonResult> ActiveOrDeActiveLanguageController(bool status, int ResourceId)
        {
            ...
            try
            {
                ...
                var serviceResponse = await _eSyaConfigAPIServices.HttpClientServices.GetAsync<DO_ReturnParameter>("Localization/ActiveOrDeActiveLanguageController" + parameter);
                if (serviceResponse.Status)
                    return Json(serviceResponse.Data);
                else
                    return Json(new DO_ReturnParameter() { Status = false, Message = serviceResponse.Message });
